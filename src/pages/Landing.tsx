      ...
      <section className="min-h-[78vh] grid place-items-center">
        <div className="max-w-3xl text-center animate-rise">
          ...
          <p className="mt-6 text-base md:text-lg text-muted-foreground max-w-xl mx-auto">
            Dev-Assistant guides you step-by-step — from concepts to monitored coding assessments — so progress feels intentional, not random. Powered by an AI mentor that explains the <em>why</em>, not just the answer.
          </p>
